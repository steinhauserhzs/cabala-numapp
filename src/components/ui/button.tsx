...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-mystical",
        destructive: "bg-destructive text-destructive-foreground",
        outline: "border border-primary/30 bg-background",
        secondary: "bg-gradient-celestial text-secondary-foreground shadow-glow",
        ghost: "bg-background text-foreground",
        link: "text-primary underline-offset-4 underline",
        mystical: "bg-gradient-cosmic text-primary-foreground shadow-mystical",
        cosmic: "bg-accent border border-primary/20 text-accent-foreground",
      },
      size: {
